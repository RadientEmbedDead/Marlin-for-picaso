...
#define SWITCHING_NOZZLE
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES { 0, 80 }   // Angles for E0, E1 (single servo) or lowered/raised (dual servo)
#endif
...
#define HOTEND_OFFSET_Z { 0.0, 0.20 }  // (mm) relative Z-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 85.33, 85.33, 800, 408 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  15, 0, (Z_MIN_POS + 1) }, {  (X_BED_SIZE+20), 0, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 0, 1, (Z_MIN_POS + 1) }, {  (X_BED_SIZE+20), 1, (Z_MIN_POS + 1) } }

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 1
